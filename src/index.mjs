 ...
 * @system
 *
 * generated_on: 2025-03-07T19:51:39.688Z
 * certified_version: 1.0.0
 * file_uuid: 7de0818b-6783-435d-9632-8b1519a4f921
 * file_size: 13824 bytes
 * file_hash: 87c9288a1971edeb0f722bfeda80de3e10ce22946114c1fba1aa4e392b9ed1a4
 * mast_hash: 2b6427b7a1330f623be20379494ccf02a8775c879240ed29722d355cb93b2710
 *  
 *
********************************************************/
    ...
    */
    ...
    getMeaningfulTextContent() {
        return this._children
            .map(child => (typeof child.getMeaningfulTextContent === 'function') ? child.getMeaningfulTextContent() : '')
            .join(' ')
            .trim();
    }
...
class SanitizedText extends Node {
    ...
    static get nodeType() { return 'sanitized-text'; }
