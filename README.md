...
[https://github.com/alexstevovich/lydio](https://github.com/alexstevovich/lydio)
  ...
  **Lydio** is a fully programmatic HTML authoring tool built for long-term, large-scale projects that demand total control and zero dependency overhead. It’s the tool I use to build every site I create, and it’s been refined over years of production use.
