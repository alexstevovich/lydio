...
**Lydio** is a fully programmatic HTML authoring tool built for long-term, large-scale projects that demand total control and zero dependency overhead. It’s the tool I use to build most of the sites I create, and it’s been refined over years of production use.
...
Check out [Marle](https://github.com/alexstevovich/marle), a companion package for programmatic CSS authoring.

## License

Lydio is currently proprietary and shared as part of my public portfolio to demonstrate engineering capability.
